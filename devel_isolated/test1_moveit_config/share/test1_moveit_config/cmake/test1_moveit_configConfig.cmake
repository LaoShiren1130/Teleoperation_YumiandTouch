...
if(test1_moveit_config_CONFIG_INCLUDED)
  return()
endif()
set(test1_moveit_config_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(test1_moveit_config_SOURCE_PREFIX /home/xiaohulu1130/teleop_ws/src/ABB_IRB14000_Moveit)
  set(test1_moveit_config_DEVEL_PREFIX /home/xiaohulu1130/teleop_ws/devel_isolated/test1_moveit_config)
  set(test1_moveit_config_INSTALL_PREFIX "")
  set(test1_moveit_config_PREFIX ${test1_moveit_config_DEVEL_PREFIX})
else()
  set(test1_moveit_config_SOURCE_PREFIX "")
  set(test1_moveit_config_DEVEL_PREFIX "")
  set(test1_moveit_config_INSTALL_PREFIX /home/xiaohulu1130/teleop_ws/install_isolated)
  set(test1_moveit_config_PREFIX ${test1_moveit_config_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'test1_moveit_config' is deprecated")
...
set(test1_moveit_config_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(test1_moveit_config_INCLUDE_DIRS "")
  set(_include_dirs "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${test1_moveit_config_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test1_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'test1_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xiaohulu1130/teleop_ws/src/ABB_IRB14000_Moveit/${idir}'.  ${_report}")
    endif()
    _list_append_unique(test1_moveit_config_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND test1_moveit_config_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND test1_moveit_config_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT test1_moveit_config_NUM_DUMMY_TARGETS)
      set(test1_moveit_config_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::test1_moveit_config::wrapped-linker-option${test1_moveit_config_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR test1_moveit_config_NUM_DUMMY_TARGETS "${test1_moveit_config_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::test1_moveit_config::wrapped-linker-option${test1_moveit_config_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND test1_moveit_config_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(test1_moveit_config_LIBRARY_DIRS ${lib_path})
      list(APPEND test1_moveit_config_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'test1_moveit_config'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND test1_moveit_config_LIBRARIES ${lib})
    endif()
  endif()
...
set(test1_moveit_config_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${test1_moveit_config_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 test1_moveit_config_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${test1_moveit_config_dep}_FOUND)
      find_package(${test1_moveit_config_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${test1_moveit_config_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(test1_moveit_config_INCLUDE_DIRS ${${test1_moveit_config_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(test1_moveit_config_LIBRARIES ${test1_moveit_config_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${test1_moveit_config_dep}_LIBRARIES})
  _list_append_deduplicate(test1_moveit_config_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(test1_moveit_config_LIBRARIES ${test1_moveit_config_LIBRARIES})

  _list_append_unique(test1_moveit_config_LIBRARY_DIRS ${${test1_moveit_config_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(test1_moveit_config_EXPORTED_TARGETS ${${test1_moveit_config_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${test1_moveit_config_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
