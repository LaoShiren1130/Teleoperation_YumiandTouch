...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_mimic_SOURCE_PREFIX /home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/yumi/gazebo_mimic)
  set(gazebo_mimic_DEVEL_PREFIX /home/xiaohulu1130/teleop_ws/devel_isolated/gazebo_mimic)
  ...
  set(gazebo_mimic_INSTALL_PREFIX /home/xiaohulu1130/teleop_ws/install_isolated)
...
if(NOT "/home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/yumi/gazebo_mimic/include " STREQUAL " ")
  set(gazebo_mimic_INCLUDE_DIRS "")
  set(_include_dirs "/home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/yumi/gazebo_mimic/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Robert Krug <robert.krug@oru.se>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_mimic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/yumi/gazebo_mimic/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gazebo_mimic_NUM_DUMMY_TARGETS)
      set(gazebo_mimic_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gazebo_mimic::wrapped-linker-option${gazebo_mimic_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gazebo_mimic_NUM_DUMMY_TARGETS "${gazebo_mimic_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gazebo_mimic::wrapped-linker-option${gazebo_mimic_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gazebo_mimic_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(gazebo_mimic_EXPORTED_TARGETS ${${gazebo_mimic_dep}_EXPORTED_TARGETS})
endforeach()
