...
if("TRUE" STREQUAL "TRUE")
  set(industrial_trajectory_filters_SOURCE_PREFIX /home/xiaohulu1130/teleop_ws/src/industrial_core/industrial_trajectory_filters)
  set(industrial_trajectory_filters_DEVEL_PREFIX /home/xiaohulu1130/teleop_ws/devel_isolated/industrial_trajectory_filters)
  ...
  set(industrial_trajectory_filters_INSTALL_PREFIX /home/xiaohulu1130/teleop_ws/install_isolated)
...
if(NOT "/home/xiaohulu1130/teleop_ws/src/industrial_core/industrial_trajectory_filters/include " STREQUAL " ")
  set(industrial_trajectory_filters_INCLUDE_DIRS "")
  set(_include_dirs "/home/xiaohulu1130/teleop_ws/src/industrial_core/industrial_trajectory_filters/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_trajectory_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xiaohulu1130/teleop_ws/src/industrial_core/industrial_trajectory_filters/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(industrial_trajectory_filters_EXPORTED_TARGETS ${${industrial_trajectory_filters_dep}_EXPORTED_TARGETS})
endforeach()
