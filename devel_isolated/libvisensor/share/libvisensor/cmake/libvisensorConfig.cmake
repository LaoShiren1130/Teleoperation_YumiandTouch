...
if(libvisensor_CONFIG_INCLUDED)
  return()
endif()
set(libvisensor_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(libvisensor_SOURCE_PREFIX /home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/libvisensor_devel)
  set(libvisensor_DEVEL_PREFIX /home/xiaohulu1130/teleop_ws/devel_isolated/libvisensor)
  set(libvisensor_INSTALL_PREFIX "")
  set(libvisensor_PREFIX ${libvisensor_DEVEL_PREFIX})
else()
  set(libvisensor_SOURCE_PREFIX "")
  set(libvisensor_DEVEL_PREFIX "")
  set(libvisensor_INSTALL_PREFIX /home/xiaohulu1130/teleop_ws/install_isolated)
  set(libvisensor_PREFIX ${libvisensor_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'libvisensor' is deprecated")
...
set(libvisensor_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/libvisensor_devel/include " STREQUAL " ")
  set(libvisensor_INCLUDE_DIRS "")
  set(_include_dirs "/home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/libvisensor_devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${libvisensor_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'libvisensor' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'libvisensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/libvisensor_devel/${idir}'.  ${_report}")
    endif()
    _list_append_unique(libvisensor_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "visensor")
foreach(library ${libraries})
  # keep build configuration keywords, target names and absolute libraries as-is
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND libvisensor_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND libvisensor_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT libvisensor_NUM_DUMMY_TARGETS)
      set(libvisensor_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::libvisensor::wrapped-linker-option${libvisensor_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR libvisensor_NUM_DUMMY_TARGETS "${libvisensor_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::libvisensor::wrapped-linker-option${libvisensor_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND libvisensor_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(libvisensor_LIBRARY_DIRS ${lib_path})
      list(APPEND libvisensor_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'libvisensor'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND libvisensor_LIBRARIES ${lib})
    endif()
  endif()
...
set(libvisensor_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${libvisensor_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 libvisensor_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${libvisensor_dep}_FOUND)
      find_package(${libvisensor_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${libvisensor_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(libvisensor_INCLUDE_DIRS ${${libvisensor_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(libvisensor_LIBRARIES ${libvisensor_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${libvisensor_dep}_LIBRARIES})
  _list_append_deduplicate(libvisensor_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(libvisensor_LIBRARIES ${libvisensor_LIBRARIES})

  _list_append_unique(libvisensor_LIBRARY_DIRS ${${libvisensor_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(libvisensor_EXPORTED_TARGETS ${${libvisensor_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${libvisensor_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
