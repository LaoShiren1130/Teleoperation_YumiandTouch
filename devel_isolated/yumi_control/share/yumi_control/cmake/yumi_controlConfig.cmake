...
if("TRUE" STREQUAL "TRUE")
  set(yumi_control_SOURCE_PREFIX /home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/yumi/yumi_control)
  set(yumi_control_DEVEL_PREFIX /home/xiaohulu1130/teleop_ws/devel_isolated/yumi_control)
  ...
  set(yumi_control_INSTALL_PREFIX /home/xiaohulu1130/teleop_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yumi_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xiaohulu1130/teleop_ws/src/YuMi-ROS_control_code_in_ROS/src/yumi/yumi_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT yumi_control_NUM_DUMMY_TARGETS)
      set(yumi_control_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::yumi_control::wrapped-linker-option${yumi_control_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR yumi_control_NUM_DUMMY_TARGETS "${yumi_control_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::yumi_control::wrapped-linker-option${yumi_control_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND yumi_control_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(yumi_control_EXPORTED_TARGETS ${${yumi_control_dep}_EXPORTED_TARGETS})
endforeach()
